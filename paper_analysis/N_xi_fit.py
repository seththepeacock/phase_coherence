        ...
        for bw in bws:
            ...
            for species in speciess:
                for wf_idx in wf_idxs:
                    ...
                    all_results_folder = (
                        paper_analysis_folder + rf"Results/Results (All)"
                    )
                    ...
                    if output_peak_picks:
                        ...
                        f_psd, psd = pc.get_welch(wf=wf, fs=fs, tau=tau_psd, win="hann")
                    ...
                    if output_fits:
                        ...
                        for peak_freqs, peak_idxs, good_peaks in zip(
                            ...
                            for f0, peak_idx, color, subplot_idx in zip(
                                ...
                                plot_noise_floor = True if f0s_cgram is None else False
                                pc.plot_N_xi_fit(
                                    N_xi_dict, color, plot_noise_floor=plot_noise_floor
                                )
