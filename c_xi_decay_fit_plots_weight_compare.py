...
for sigma_weighting_power in [0, -1]:
    for wf_idx in [0, 2, 4, 5, 6, 7]: # Started with 0, 2 (Lizard) - 4, 5 (Owl) - 6, 7 (Human)
        ...
        get_fit_sigma = lambda y, sigma_weighting_power: (y + 1e-9)**sigma_weighting_power
        ...
        plt.savefig(f'{fig_folder}/{fn_id} - sigma=y^{sigma_weighting_power} - C_xi decays fitted with {fit_func_type}.png', dpi=300)
        # plt.show()
